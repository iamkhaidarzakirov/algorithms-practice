"""Есть список музыкальных исполнителей и количество воспроизведений для каждого исполнителя.
> Этот список передается в виде текстового документа, где каждый исполнитель на новой строке.
>> Пример строки:<исполнитель>: <количество_воспроизведений>
> Нужно прочитать файл и отсортировать исполнителей от большего числа воспроизведений к меньшему.
>После сортировки вывести каждого исполнителя на новой строке.
>> Пример вывода:<исполнитель>: <количество_воспроизведений>"""
